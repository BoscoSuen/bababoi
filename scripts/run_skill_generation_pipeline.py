...
def _get_staged_files(project_root: Path, skill_name: str) -> list[str]:
    ...
    result = subprocess.run(
        [
            ...
            f"docs/zh/skills/{skill_name}.md",
...
def _rollback_skill(project_root: Path, skill_name: str, branch_name: str) -> None:
    ...
    # tracked paths — notably docs/{en,zh}/skills/index.md — dirty and blocking
...
def create_skill_pr(
    ...
    if doc_gen_script.exists():
        ...
        if doc_result.returncode == 0:
            ...
            doc_paths = [f"docs/en/skills/{skill_name}.md", f"docs/zh/skills/{skill_name}.md"]
            for dp in doc_paths:
    ...
    pr_body = (
        ...
        f"## Post-merge TODO\n"
        f"- [ ] Add skill to README.md and README.zh.md\n"
