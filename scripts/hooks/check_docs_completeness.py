...
docs/en/skills/ and docs/zh/skills/. Runs on all files (pass_filenames: false)
...
def find_skills_without_docs() -> list[str]:
    ...
    docs_zh_dir = PROJECT_ROOT / "docs" / "zh" / "skills"
    errors = []
