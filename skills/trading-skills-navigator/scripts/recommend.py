...
PERSONAS: tuple[Persona, ...] = (
    ...
    Persona(
        ...
        any_terms=(
            ...
            "contrarian futures",
            "contrarian fade",
            # ZH — normalize_query lowercases, so "COT" -> "cot"
            "夏皮罗",
            "杰森夏皮罗",
            "cot报告",
            "cot数据",
    ...
    Persona(
        ...
        any_terms=(
            ...
            "free only",
            "no paid",
            # ZH — normalize_query lowercases, so "API" -> "api"
            "无需api",
            "不需要api",
            "api不要",
            "不用api",
    ...
    # Monthly review must precede the generic journal persona: Chinese
    # phrases such as "这个月的复盘" intentionally match both, and the more
