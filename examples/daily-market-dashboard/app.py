...
_TEXTS: dict[str, dict[str, str]] = {
    ...
    "zh": {
        "sidebar_title": "项目配置",
        "sidebar_project": "项目: `{project}`",
        "sidebar_auth": "认证: `{auth}`",
        "clear_chat": "清空聊天",
        "config_issue": "检测到配置问题。",
        "prompt_placeholder": "输入消息...",
        "thinking": "思考中...",
        "note": "注意",
        "running_tool": "正在执行 {label}...",
        "rate_limit_exceeded": ("已超出发送上限（每分钟{limit}条）。请在约{seconds}秒后重试。"),
        "chat_error": ("错误: 聊天请求失败。请检查认证和网络设置。 详情: {details}"),
        "no_response": "（无响应）",
        "attachments_selected": "已附加文件:",
        "attachments_error": "附件设置错误: {details}",
        "attachment_only_prompt": "请分析附加文件并总结要点。",
        "knowledge_error": "知识库设置错误: {details}",
        "dashboard_title": "仪表板",
        "dashboard_regenerate": "重新生成仪表板",
        "dashboard_running": "正在运行5个技能...",
        "dashboard_success": "仪表板已更新。刷新页面即可查看最新数据。",
        "dashboard_failed": "失败: {details}",
        "dashboard_empty": "暂无仪表板。请点击侧栏的 **重新生成仪表板** 按钮进行生成。",
        "dashboard_lang_label": "语言",
        "tab_chat": "聊天",
    },
}
